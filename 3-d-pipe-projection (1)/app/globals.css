...
:root {
  /* AquaComunidad Theme - Water & Prevention */
  ...
  /* Primary - Azul Agua */
  --primary: oklch(0.65 0.19 220);
  --primary-foreground: oklch(1 0 0);
  
  /* Secondary - Verde Prevención */
  --secondary: oklch(0.65 0.17 165);
  ...
  --ring: oklch(0.65 0.19 220);
  
  /* Chart Colors */
  --chart-1: oklch(0.65 0.19 220);
  --chart-2: oklch(0.65 0.17 165);
  --chart-3: oklch(0.7 0.14 185);
  --chart-4: oklch(0.8 0.16 85);
...
.dark {
  ...
  --danger: oklch(0.7 0.16 50);
  --danger-foreground: oklch(0.95 0 0);
  --destructive: oklch(0.55 0.22 25);
  --destructive-foreground: oklch(0.95 0 0);
  --success: oklch(0.6 0.15 165);
...
.risk-gradient {
  background: conic-gradient(
    from 180deg,
    oklch(0.65 0.17 165) 0%,
    oklch(0.8 0.16 85) 50%,
    oklch(0.63 0.24 25) 100%
  );
}
